...
class Game {
  ...
  addCars() {
    var car1 = new Car(-150, 562.5, 43, 150, 'rgb(14, 15, 117)', 1, 2.5);
    this.cars.push(car1)
    var car2 = new Car(200, 525, 43, 100, 'rgb(14, 15, 117)', 1, 2.5);
    this.cars.push(car2)
    var car3 = new Car(350, 487.5, 43, 150, 'rgb(14, 185, 117)', 1, 2.5);
    this.cars.push(car3)
    var car4 = new Car(500, 450, 43, 100, 'rgb(14, 185, 117)', 1, 2.5);
    this.cars.push(car4)
    var car5 = new Car(-250, 412.5, 43, 150, 'rgb(14, 185, 117)', 1, 2.5);
    this.cars.push(car5)
  }
  addLogs() {
