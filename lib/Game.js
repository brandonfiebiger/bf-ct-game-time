...
class Game {
  ...
  gameOver(ctx) {
    if (lives.life === 0) {
      ctx.fillStyle = 'rgb(0, 0, 0)';
      ctx.fillRect (0, 700, 600, 700);
      ctx.font = '48px serif';
      ctx.fillStyle = 'rgb(13, 188, 121)';
  ...
  //    for (let i = 1; i < 5; i++) {
  //     this.logRows.forEach(log => {
  //       let newLog = new Log(log.x + log.width * (2*i), log.y, 43, 125, 'rgb(148, 90, 48)', 1, 3.5)
  //       this.logs.push(newLog)
  //     })
  //   }
  //    for (let i = 1; i < 2; i++) {
